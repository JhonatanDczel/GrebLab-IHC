interface Activity {
  ...
  export type TitleKeys = keyof typeof Titles;
  export type TitleValues = typeof Titles[TitleKeys];
  
  export const TEST_CONCAT_DELIM = "~`";
  export const DELIM = TEST_CONCAT_DELIM;
  export const LOCK_MARKER = "(l)";
  
  export const SAMPLES_FOR_LOOP: Activity[] = [
    {
  ...
  export const ACTIVITIES_FOR_LOOP: Activity[] = [
    {
  ...
  export const SAMPLES_FUNCTIONS: Activity[] = [
    {
        title: 'Using print()',
  ...
  export const ACTIVITIES_FUNCTIONS: Activity[] = [
    {
  ...
  export const SAMPLES_UNIT_TESTING: Activity[] = [
    {
        title: 'Simple Tests',
  ...
  export const ACTIVITIES_UNIT_TESTING: Activity[] = [
    {
        title: 'Warm-Up Activity',
  ...
  export const SAMPLES_ADVANCED_UNIT_TESTING: Activity[] = [
    {
        title: 'Simple Tests',
        instructions: 'This example shows how we can unit test an addition function',
        code:
  ...
  export const ACTIVITIES_ADVANCED_UNIT_TESTING: Activity[] = [
    {
        title: 'Warm-Up Activity',
  ...
  export const SAMPLES_ARRAYS: Activity[] = [
    {
  ...
  export const ACTIVITIES_ARRAYS: Activity[] = [
    {
        title: 'Warm-up Activity',
  ...
  export const SAMPLES_MAPS: Activity[] = [
    {
        title: 'Creating Maps',
  ...
  export const ACTIVITIES_MAPS: Activity[] = [
    {
        title: 'Warm-up Activity',
  ...
  export const ACTIVITIES_LISTS: Record<TitleValues, Activity[]> = {
    "ForLoops": ACTIVITIES_FOR_LOOP,
    "Functions": ACTIVITIES_FUNCTIONS,
    "UnitTests": ACTIVITIES_UNIT_TESTING,
    "AdvUnitTests": ACTIVITIES_ADVANCED_UNIT_TESTING,
    "Arrays": ACTIVITIES_ARRAYS,
    "Maps": ACTIVITIES_MAPS
  };
  
  export const SAMPLES_LISTS: Record<TitleValues, Activity[]> = {
    "ForLoops": SAMPLES_FOR_LOOP,
    "Functions": SAMPLES_FUNCTIONS,
    "UnitTests": SAMPLES_UNIT_TESTING,
    "AdvUnitTests": SAMPLES_ADVANCED_UNIT_TESTING,
    "Arrays": SAMPLES_ARRAYS,
    "Maps": SAMPLES_MAPS
  };
